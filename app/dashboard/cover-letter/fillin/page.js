...
const handleChange=(e)=>{
    ...
    return (
    <>
    <div  className={` flex  justify-center items-center p-4    bg-center ${isOpen ? 'ml-[25%]': ''} transition-all duration-500 overflow-auto `} >
<form onSubmit={handleClick} className={`transition-all duration-500 w-full  h-full bg-white/5  border border-white  shadow-2xl  rounded-3xl  p-10 `}>
    ...
    <div className="text-center mb-8 relative">
            ...
            <h1 className="relative text-5xl font-bold bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 bg-clip-text text-transparent mb-2 animate-gradient-move">
    ...
    <div className='relative group '>
      ...
      <textarea ref={jobDescription} rows={6} className='focus:outline-none focus:border-violet-500 focus:bg-white/10 bg-white/5 border-white/10 border  w-full rounded-md p-2 placeholder:text-white/40 resize-none' placeholder='Paste the job description here' required></textarea>
      </div>
      ...
      <div className='relative group/input mb-6'>
      <div className='absolute inset-0  bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-pink-500/20 blur-3xl opacity-0 group-hover/input:opacity-100 transition-all duration-300 pointer-events-none'></div>
      <input ref={skills} className='focus:outline-none focus:border-violet-500 focus:bg-white/10 bg-white/5 border-white/10 border  w-full rounded-md p-2 placeholder:text-white/40' placeholder='e.g., ReactJs,NextJs,Devops,etc...' required/>
      </div>
      </div>
      </div>
      ...
      <div onClick={handleDivClick} className="relative group/upload cursor-pointer">
     ...
     <div className='relative group '>
      ...
      <label className="block text-white/80 font-medium mb-3 flex items-center gap-2">
        ...
        <div className='relative group/input mb-6'>
          <div className='absolute inset-0  bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-pink-500/20 blur-3xl opacity-0 group-hover/input:opacity-100 transition-all duration-300 pointer-events-none'></div>
            <input ref={recruiterName} className='focus:outline-none focus:border-violet-500 focus:bg-white/10 bg-white/5 border-white/10 border  w-full rounded-md p-2 placeholder:text-white/40' placeholder='John Doe' required/>
          </div>
        </div>
        <div>
      <label className="block text-white/80 font-medium mb-3 flex items-center gap-2">
        ...
        <div className='relative group/input mb-6'>
          <div className='absolute inset-0  bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-pink-500/20 blur-3xl opacity-0 group-hover/input:opacity-100 transition-all duration-300 pointer-events-none'></div>
            <input ref={designation} className='focus:outline-none focus:border-violet-500 focus:bg-white/10 bg-white/5 border-white/10 border  w-full rounded-md p-2 placeholder:text-white/40' placeholder='Hiring Manager (HR)' required/>
          </div>
        </div>
        <div>
      <label className="block text-white/80 font-medium mb-3 flex items-center gap-2">
        ...
        <div className='relative group/input mb-6'>
          <div className='absolute inset-0  bg-gradient-to-r from-blue-500/20 via-purple-500/20 to-pink-500/20 blur-3xl opacity-0 group-hover/input:opacity-100 transition-all duration-300 pointer-events-none'></div>
            <input ref={companyName} className='focus:outline-none focus:border-violet-500 focus:bg-white/10 bg-white/5 border-white/10 border  w-full rounded-md p-2 placeholder:text-white/40' placeholder='Tech Solutions Inc.' required/>
          </div>
        </div>
      </div>
      </div>
